<?php
    ...
    class Form {
        ...
        public function addTextField($name, $type, $value, $placeholder) {
            ...
            $this->_fields[] = '<label class="label" for="'.$name.'">Votre '.$name.'</label>
            <input class="input" type="'.$type.'" id="'.$name.'" name="'.$name.'" value="'.$value.'" placeholder="'.$placeholder.'"> <br>';
        ...
        public function addSubmitButton($name) {
            $this->_button = '<button class="submit" type="submit" value="'.$name.'">'.$name.'</button><br>';
        ...
        public function build() {
                ...
                $html = "<form id='$this->_id' action='$this->_action' method='$this->_method'>";
